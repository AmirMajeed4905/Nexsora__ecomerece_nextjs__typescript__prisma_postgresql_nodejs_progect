      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            {/* Cancel Button — only while the order can still be stopped */}
            ...
            {/* Delete Button — only once the order is in a final state.
                Deleting removes it from order history entirely. */}
            {["CANCELLED", "DELIVERED"].includes(order.status) && (
              <button
                onClick={handleDelete}
                disabled={isDeleting}
                className="w-full py-3 bg-red-50 text-red-600 rounded-xl text-sm font-semibold hover:bg-red-100 transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
              >
                {isDeleting ? (
                  <>
                    <ButtonSpinner />
