    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <button onClick={openCreate}
          className="flex items-center gap-2 px-4 py-2.5 bg-gray-900 text-white text-sm font-semibold rounded-xl hover:bg-gray-800 transition-colors whitespace-nowrap">
              ...
              products.map((product) => (
                <div key={product.id} className="bg-white rounded-xl border border-gray-100 p-4">
                  ...
                  <div className="flex gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        {product.discountPrice && (
                          <span className="text-xs text-rose-500">${product.discountPrice}</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mb-3 text-xs">
                    ...
                    {product.isTrending && (
                      <span className="bg-rose-100 text-rose-700 font-bold px-2 py-1 rounded-full">🔥 Trending</span>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2 pt-3 border-t border-gray-100">
                    <button onClick={() => openEdit(product)}
                      className="flex-1 px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">
                      Edit
                    </button>
                    <button onClick={() => handleDelete(product.id)}
                      disabled={deletingId === product.id}
                      className="flex-1 px-3 py-2 text-sm font-semibold text-red-500 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-40">
                      Delete
                    </button>
                  </div>
                </div>
